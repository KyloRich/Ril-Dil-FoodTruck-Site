...
- MySQL RDS Database hosted on AWS to store form data, menu items, and GPS coordinates for food- truck location
...
<ul>
 ...
 <li> Google Maps API Used - run this in the terminal: 
    <pre><code> npm install --save google-maps
</code></pre>
 
<li> Font Awesome Icons used - run this in the terminal: 
    <pre><code>npm install --save @fortawesome/fontawesome-free
</code></pre>
 
 <li> Axios Used- run this in the terminal: 
